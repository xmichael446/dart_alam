...
class MsgClient extends $grpc.Client {
  ...
  static final _$execLegacyContent = $grpc.ClientMethod<$1.MsgExecLegacyContent,
          $1.MsgExecLegacyContentResponse>(
      '/cosmos.gov.v1.Msg/ExecLegacyContent',
      ($1.MsgExecLegacyContent value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $1.MsgExecLegacyContentResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$1.MsgExecLegacyContentResponse> execLegacyContent(
      $1.MsgExecLegacyContent request,
      {$grpc.CallOptions? options}) {
...
abstract class MsgServiceBase extends $grpc.Service {
  ...
  MsgServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$1.MsgExecLegacyContent,
            $1.MsgExecLegacyContentResponse>(
        'ExecLegacyContent',
        ...
        false,
        ($core.List<$core.int> value) =>
            $1.MsgExecLegacyContent.fromBuffer(value),
  ...
  $async.Future<$1.MsgExecLegacyContentResponse> execLegacyContent_Pre(
      $grpc.ServiceCall call,
      $async.Future<$1.MsgExecLegacyContent> request) async {
  ...
  $async.Future<$1.MsgExecLegacyContentResponse> execLegacyContent(
      $grpc.ServiceCall call, $1.MsgExecLegacyContent request);
