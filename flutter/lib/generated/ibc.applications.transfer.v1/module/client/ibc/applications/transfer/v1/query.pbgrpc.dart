...
class QueryClient extends $grpc.Client {
  ...
  static final _$escrowAddress = $grpc.ClientMethod<
          $0.QueryEscrowAddressRequest, $0.QueryEscrowAddressResponse>(
      '/ibc.applications.transfer.v1.Query/EscrowAddress',
      ($0.QueryEscrowAddressRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $0.QueryEscrowAddressResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.QueryEscrowAddressResponse> escrowAddress(
      $0.QueryEscrowAddressRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class QueryServiceBase extends $grpc.Service {
  ...
  QueryServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.QueryEscrowAddressRequest,
            $0.QueryEscrowAddressResponse>(
        'EscrowAddress',
        escrowAddress_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.QueryEscrowAddressRequest.fromBuffer(value),
  ...
  $async.Future<$0.QueryEscrowAddressResponse> escrowAddress_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.QueryEscrowAddressRequest> request) async {
  ...
  $async.Future<$0.QueryEscrowAddressResponse> escrowAddress(
      $grpc.ServiceCall call, $0.QueryEscrowAddressRequest request);
}
